...
setup(
    ...
    data_files=[
        ...
        ('lib/' + package_name + '/pix_dataclass', ['pix_vehicle_interface/pix_dataclass/DriveCtrlData.py',
                                                    ...
                                                    'pix_vehicle_interface/pix_dataclass/BrakeStaRptData.py',
                                                    'pix_vehicle_interface/pix_dataclass/ChassisWheelTorqueRptData.py',
                                                    'pix_vehicle_interface/pix_dataclass/DriveStaRptData.py',
                                                    'pix_vehicle_interface/pix_dataclass/PowerStaRptData.py',
                                                    'pix_vehicle_interface/pix_dataclass/SteerStaRptData.py',
                                                    'pix_vehicle_interface/pix_dataclass/VehicleFltRptData.py',
                                                    'pix_vehicle_interface/pix_dataclass/VehicleStaRptData.py',
                                                    'pix_vehicle_interface/pix_dataclass/VehicleWorkStaRptData.py',
