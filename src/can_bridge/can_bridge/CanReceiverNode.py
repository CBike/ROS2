...
class CanReceiverNode(Node):
    ...
    def __init__(self):
        ...
        self.throttle_report_publisher = self.create_publisher(ThrottleReport, '/throttle_report', 10)
        self.brake_report_publisher = self.create_publisher(BrakeReport, '/brake_report', 10)
        self.steer_report_publisher = self.create_publisher(SteerReport, '/steer_report', 10)
        self.gear_report_publisher = self.create_publisher(GearReport, '/gear_report', 10)
        self.park_report_publisher = self.create_publisher(ParkReport, '/park_report', 10)
        self.vcu_report_publisher = self.create_publisher(VcuReport, '/vcu_report', 10)
        self.wheel_speed_report_publisher = self.create_publisher(WheelSpeedReport, '/wheel_speed', 10)
        self.bms_report_publisher = self.create_publisher(BmsReport, '/bms_report', 10)
    ...
    def pub_vcu_report(self):
        ...
        if get_msg is not None:
            ...
            pub_msg.header.frame_id = "vehicle_control_unit_info"
            pub_msg.steer_mode_sts = get_msg['steer_mode_stst']
